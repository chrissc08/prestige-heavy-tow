    ...
    <section id="contact" className="py-20 md:py-28 bg-secondary">
      <div className="container mx-auto px-4 max-w-2xl text-center">
        ...
        <p className="text-muted-foreground text-base md:text-lg mb-8">
          If non-emergency, you may contact us after hours by clicking the box below and we will get back to you soon!
        </p>
        ...
        {!showForm ? (
          <button
            ...
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-md font-display font-bold text-lg tracking-wide hover:bg-primary/90 transition-all glow-box hover:scale-105"
          >
            <Send size={20} />
            Get in Touch
          </button>
