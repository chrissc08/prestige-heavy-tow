...
const images = [
  ...
  { src: work9, alt: "Prestige Towing hauling oversized excavator on lowboy trailer", focus: "object-[50%_35%]" },
  { src: work10, alt: "Prestige Towing bridge recovery of an overturned truck", focus: "object-[50%_35%]" },
