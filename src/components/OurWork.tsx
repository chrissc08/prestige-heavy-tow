...
const images = [
  ...
  { src: work6, alt: "Prestige Towing heavy recovery of an overturned dump truck", focus: "object-center" },
  ...
  { src: work10, alt: "Prestige Towing bridge recovery of an overturned truck", focus: "object-center" },
